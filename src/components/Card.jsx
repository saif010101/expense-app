...
const Card = ({heading,data,toggleClearDataToast,toggleRefresh,primaryUsername}) => {
  const fn = async secondaryUsername => {
    await axios.delete(`http://localhost:3000/students/${primaryUsername}/${secondaryUsername}/clearKhata`);
